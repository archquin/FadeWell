...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  5 20:31:43 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  5 19:59:38 2020
                                                ...
                                                if j != Blue:  #### blue -2
                                                  ...
                                                  #  Yellow = yellow
                                                    ...
                                                    if ( OfX == x and OfY == y ) and OfX == z+1  and ((a == 'M' or c == 'M') and b !='¬H' and d!='M' and cy2 =='M' and ln =='M'):# and b != '¬E':
                                                        ...
                                                        print(c66,'x',c77,'y',Somon,'Somon')#
                                                        FS = (z,y)
                                                        plt.imshow(cBlue)
                                                        plt.show()
                                                    elif ( OfX == x and OfY == y ) and  OfX == z-1 and ((a == 'M' or c == 'M')  and b !='¬H' and d!='M'  and cy1=='M' and ln == 'M'):# and b != '¬E':
                                                        print(c88,'x',c77,'y',Somon,'Somon')
                                                        plt.imshow(cBlue)
                                                        plt.show()
                                                    #    Grace = fadewell
                                                     #   fadewell = 1
