                                            ...
                                            while j < k:
                                              ...
                                              #  Yellow = yellow
                                                ...
                                                #    ln = 1
                                                  ...
                                                  #      print(Yellow)
                                                        k = int(somon)
                                                        if (OfX == z and OfY == y and OfX == x) and OfY == w+1 and ((a == 'M' or c == 'M')   and b !='¬H' and d!='M' and ln == 'M')  :
                                               ...
                                               #  
                                                ...
                                                if j == Blue or c != 'M' and l == 0:
                                                    ...
                                                    if ( OfX == x and OfY == y ) and OfX == z+1  and ((a == 'M' or c == 'M') and b !='¬H' and d!='M'  and cy1 =='M' and ln =='M'):# and b != '¬E':
                                                        ...
                                                        plt.imshow(cBlue)
                                                        plt.show()
                                                    elif ( OfX == x and OfY == y ) and  OfX == z-1 and ((a == 'M' or c == 'M')  and b !='¬H' and d!='M'  and cy2=='M' and ln == 'M' ):# and b != '¬E':
